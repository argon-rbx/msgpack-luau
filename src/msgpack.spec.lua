...
return function()
	...
	describe("encode", function()
		...
		it("can encode Extension value", function()
			...
			expect(hex(msgpack.encode(msgpack.Extension.new(123, buffer.fromstring("wxyz"))))).to.equal(
				"D6 7B 77 78 79 7A"
			)
			expect(hex(msgpack.encode(msgpack.Extension.new(123, buffer.fromstring("wxyzwxyz"))))).to.equal(
				"D7 7B 77 78 79 7A 77 78 79 7A"
			)
			expect(hex(msgpack.encode(msgpack.Extension.new(123, buffer.fromstring("wxyzwxyzwxyzwxyz"))))).to.equal(
			...
			xs = string.rep("x", 0x10000)
			expect(msgpack.encode(msgpack.Extension.new(123, buffer.fromstring(xs)))).to.equal(
